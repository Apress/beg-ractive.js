...
var ractive = new Ractive({
  ...
  template: `
    ...
    <p class="hide one">View details<p>
    <div class="extra one">
    ...
    <p class="hide two">View details<p>
    <div class="extra two">
    ...
    <p class="hide three">View details<p>
    <div class="extra three">
...
$(function() {
  $(".hide.one").on("click", function() {
    $("div.extra.one").toggle( "slow" );
  }); 

  $(".hide.two").on("click", function() {
    $("div.extra.two").toggle( "slow" );
  }); 

  $(".hide.three").on("click", function() {
    $("div.extra.three").toggle( "slow" );
  });   
});
